        ...
        <div className="contact-header-container">
          <AnimatedSection animation="fadeInLeft" delay={0}>
            <div className="contact-header-content">
              ...
              <h2 className="contact-header-subtitle">Let's Build Something Real</h2>
              <p className="contact-header-description">
                Questions, ideas, partnerships, or opportunities?
                Reach out to the Chain Neo team and let's move blockchain adoption in East Africa from talk to action.
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fadeInUp" delay={0}>
            <div className="contact-info-header">
              ...
              <p className="contact-info-description">
                Connect with our growing community of blockchain builders, learners, and innovators. Join discussions, get support, and stay updated on the latest opportunities in East Africa's blockchain ecosystem.
              </p>
            </div>
          </AnimatedSection>
          <div className="contact-channels">
            <AnimatedSection animation="fadeInUp" delay={100}>
              ...
              <div className="contact-channel-info">
                ...
                <span className="contact-channel-value">Get in touch with the Chain Neo team for questions, partnerships, or opportunities. Reach out and let's move blockchain adoption in East Africa from talk to action.</span>
              </div>
              </a>
            </AnimatedSection>

            <AnimatedSection animation="fadeInUp" delay={200}>
              <a href="https://linkedin.com/company/chainneo" target="_blank" rel="noopener noreferrer" className="contact-channel">
              <div className="contact-channel-icon">
              ...
              <div className="contact-channel-info">
                ...
                <span className="contact-channel-value">Updates and news with a focus on business applications and partnerships, along with articles and thought leadership pieces from industry experts.</span>
              </div>
              </a>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fadeInUp" delay={300}>
              ...
              <div className="contact-channel-info">
                ...
                <span className="contact-channel-value">Join our community group for events, feedback, questions, mentoring, expert guidance, and networking with blockchain builders across East Africa.</span>
              </div>
              </a>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fadeInUp" delay={400}>
              ...
              <div className="contact-channel-info">
                ...
                <span className="contact-channel-value">Follow Chain Neo for the latest updates, news, and community highlights. Stay connected with East Africa's fastest-growing blockchain community.</span>
              </div>
              </a>
            </AnimatedSection>
          </div>
